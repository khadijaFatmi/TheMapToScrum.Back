...
namespace TheMapToScrum.Back.API
{
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      sl.WriteUsage(new LogItem() { Message = "startup modifié ", AlerteEmail = true }) ;
      ...
      services.AddScoped<ITaaskLogic, TaaskLogic>();
      services.AddScoped<ITaaskRepository, TaaskRepository>();
